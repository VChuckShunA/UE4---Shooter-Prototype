...
void AItem::BeginPlay()
{
	...
	//Set Item propeties based on ItemState
	SetItemPropeties( ItemState);


	//Set custom deoth to disbaled
	InitiatlizeCustomDepth();
...
void AItem::SetItemPropeties(EItemState State)
{
	...
	case EItemState::EIS_Pickup:
		...
		//Set AreaSPhere propeties
		AreaSphere->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Overlap);
		AreaSphere->SetCollisionEnabled(ECollisionEnabled::QueryOnly);
		//SetCollisionBox propeties
		CollisionBox->SetCollisionResponseToAllChannels(ECollisionResponse::ECR_Ignore);
		CollisionBox->SetCollisionResponseToChannel(ECollisionChannel::ECC_Visibility, ECollisionResponse::ECR_Block);
...
void AItem::ItemInterp(float DeltaTime)
{
	...
	if (Character && ItemZCurve)
	{
		...
		//Set X & Y of ItemLocation to Interped values
...
void AItem::InitiatlizeCustomDepth()
{
	DisableCustomDepth();
}
...
void AItem::Tick(float DeltaTime)
{
	...
	//hadnle Item Interpingwhen in the EquipInterping state
	ItemInterp(DeltaTime);

	//Get Curve values from pulse curve ands et dynamic  material paramters
	UpdatePulse();
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	//Add 1 to the item count for this location struct
	Character->IncrementInterpLocItemCount(InterpLocIndex, 1);
	...
	//Intial yaw offset between amera and Item
