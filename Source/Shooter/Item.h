...
protected:
	...
	//Set the ActiveStars array if bools based on rarity
	void SetActiveStars();

	//Sets propeties of the Item's components based on State
	...
	virtual void InitiatlizeCustomDepth();
...
private:
	...
	//Enables item tracing when overllaped
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	...
	//Starting lcoation when interping begins
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	...
	//X & Y for the item while interping in the EquipInterping state
	float ItemInterpX;
	float ItemInterpY;
	...
	//Enum for the typeof item this item is
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
		EItemType ItemType;
	...
	//Index for the material we like to change at runtime
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
		int32 MaterialIndex;
	...
	//Curve to drive the dynamic amterial parameters
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Item Properties", meta = (AllowPrivateAccess = "true"))
	...
	//Dark Clor in the pickup widget
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Rarity, meta = (AllowPrivateAccess = "true"))
		FLinearColor DarkColor;
...
public:
	...
	//Set item icon for the invenotyr
